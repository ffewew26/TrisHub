...
Tabs.Main:AddButton({
    ...
    Callback = function()
        if setclipboard then
            setclipboard("https://discord.gg/qvhTzkS83")
        end
    end
})
...
game.StarterGui:SetCore('SendNotification', {
    ...
    Icon = 'rbxassetid://85499905225554',
    Duration = 100000,
    Button1 = 'Yes',
    Button2 = 'No',
})
...
Image.Image = "rbxassetid://85499905225554"
...
print('\u{2705} Smooth + Stable Anti-Lag Activated - Made by vũ đạt')
game.StarterGui:SetCore('SendNotification', {
    Title = 'đã tải xong',
    Text = 'chống lag Functions\u{2705}',
    Icon = 'rbxassetid://85499905225554',
    Duration = 8,
})
